...
class ResponseEVArchivos(Model):
    ...
    """
    def __init__(self, status: int=None, file_name: str=None, elementos: List[str]=None, internal_transaction_id: str=None, external_transaction_id: str=None):  # noqa: E501
        """ResponseEVArchivos - a model defined in Swagger

        :param status: The status of this ResponseEVArchivos.  # noqa: E501
        :type status: int
        :param file_name: The file_name of this ResponseEVArchivos.  # noqa: E501
        :type file_name: str
    ...
    def file_name(self) -> str:
        """Gets the file_name of this ResponseEVArchivos.


        :return: The file_name of this ResponseEVArchivos.
        :rtype: str
        """
    ...
    def file_name(self, file_name: str):
        """Sets the file_name of this ResponseEVArchivos.


        :param file_name: The file_name of this ResponseEVArchivos.
        :type file_name: str
        """
